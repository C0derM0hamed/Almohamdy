...
const ROLES = [
  ...
  },
  {
    ...
    allowed: [ADMIN_ONLY[0], ...TRAINING_MODULES],
    denied: [ADMIN_ONLY[1], ...MEDICAL_MODULES],
    optionalAllowedFromEnv: true,
  },
  {
    key: 'PW_AUDIT_BRANCH_A',
    allowed: [...MODULES, ...TRAINING_MODULES],
    denied: [...ADMIN_ONLY, ...MEDICAL_MODULES],
  ...
  },
  {
    ...
    allowed: [...MODULES, ...TRAINING_MODULES, ...MEDICAL_MODULES],
    denied: [...ADMIN_ONLY],
