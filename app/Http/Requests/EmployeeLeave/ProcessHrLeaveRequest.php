...
class ProcessHrLeaveRequest extends FormRequest
{
    use AuthorizesEmployeeLeave;

    public function authorize(): bool
    {
        return $this->authorizePermission(EmployeeLeavePermissions::HR_PROCESS);
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function (Validator $validator): void {
            ...
            if (! app(LeaveRequestService::class)->canProcessHr($record)) {
                $validator->errors()->add('decision', __('employee_leave.errors.hr_not_pending'));
            }
        });
    }
