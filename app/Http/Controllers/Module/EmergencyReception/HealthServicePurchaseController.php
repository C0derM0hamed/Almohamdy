...
final class HealthServicePurchaseController extends Controller
{
    ...
    public function download(int $record, int $attachment): mixed
    {
        return $this->service->downloadAttachment($record, $attachment);
    }
    ...
    {
        return view('modules.emergency-reception.health-result');
    }
}
