...
class EmployeeRequestController extends Controller
{
    ...
    public function pdf(string $type, int $id): mixed { return app(ArabicPdfService::class)->loadView('employee-requests.pdf', $this->service->pdf($type, $id))->setPaper('a4')->download('employee-request-'.$type.'-'.$id.'.pdf'); }
}
