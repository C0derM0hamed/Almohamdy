@extends('layouts.app')
@section('title', __('training.management'))
...
<div class="hm-module-page" data-module="training-management">
    <div class="d-flex flex-wrap justify-content-between align-items-center gap-3 mb-4">
        <div><h1 class="h3 mb-1">{{ __('training.management') }}</h1><p class="text-muted mb-0">{{ __('training.subtitle') }}</p></div>
    ...
    <div class="card mb-4"><div class="card-body">
        <form method="GET" class="row g-3 align-items-end">
            ...
            <div class="col-md-2 d-flex gap-2"><button class="btn btn-dark flex-grow-1">{{ __('training.search') }}</button><a href="{{ route('modules.training.management.index') }}" class="btn btn-outline-secondary">{{ __('training.reset') }}</a></div>
        </form>
    </div></div>
    <div class="card"><div class="table-responsive"><table class="table table-hover align-middle mb-0">
        ...
        <tbody>@forelse($trainings as $training)<tr>
            ...
            <td><a class="btn btn-sm btn-outline-primary" href="{{ route('modules.training.management.show', $training->id) }}">{{ __('training.details') }}</a></td>
...
<div class="modal fade" id="newTraining" tabindex="-1"><div class="modal-dialog modal-lg"><form method="POST" action="{{ route('modules.training.management.store') }}" class="modal-content">@csrf
