...
@section('title', __('doctors_directory_admin.edit_department_assignment'))
    ...
    <div class="hm-dda hm-dda--department-form">
        @include('doctors-directory-admin.partials.dda-breadcrumb', [
            'items' => [
                ...
                ['label' => __('doctors_directory_admin.edit_department_assignment'), 'chip' => true],
            ],
        ])

        @include('doctors-directory-admin.partials.dda-page-hero', [
            'title' => __('doctors_directory_admin.edit_department_assignment'),
            'subtitle' => $section->outpatientClinic?->localizedName() ?? '—',
        ])
