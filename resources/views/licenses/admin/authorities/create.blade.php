...
@section('content')<div class="hm-licenses">@include('licenses.admin._reference-form',['resource'=>'authorities','resourceLabel'=>__('licenses.admin.authorities')])</div>@endsection
